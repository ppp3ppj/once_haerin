...
# docker build -t once_minji .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name once_minji once_minji
...
# Install JS dependencies (DaisyUI for Tailwind plugin)
